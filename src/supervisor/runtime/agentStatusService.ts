...
// v34 adds the follow-up deliveries an adapter declares it can perform; a
// snapshot without the field answers "which deliveries?" with silence, which
// the composer reads as a refusal to name any timing at all.
